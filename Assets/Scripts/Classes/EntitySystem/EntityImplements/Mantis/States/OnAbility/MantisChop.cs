...
namespace Unchord
{
    public class MantisChop : MantisAttack, ISkillEvent
    {
...
*/
        ...
        public void OnSkill(SkillModule _skModule)
        {
            List<Entity> targets = _skModule
                .Reset()
                .SenseColliders(instance.skillRange_Chop_01)
                .GetTargets();

            instance.skillRange_Chop_01.DebugSensor(UnityEngine.Color.cyan, 2.0f);
