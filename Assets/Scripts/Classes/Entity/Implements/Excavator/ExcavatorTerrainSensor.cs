...
{
    [Serializable]
    public class ExcavatorTerrainSensor : TerrainSensor<Excavator>
    {
        ...
        protected override void SetOrigins(Excavator _instance)
        {
        ...
        protected override void DetectTerrains(Excavator _instance)
        {
        ...
        protected override void SetDirectionVector(Excavator _instance)
        {
            float nx = 1;
            float ny = 0;
