...
namespace UnchordMetroidvania
{
    public static class EntitySensor
    {
        ...
        public static Collider2D[] OverlapBox(EntityBase origin, LTRB range, EntitySensorGizmo gizmo)
        {
            ...
            if(gizmo.bShowGizmo)
                origin.skillRangeGizmoManager.Add(new BoxRangeGizmo(gizmo.duration, gizmo.color, pStart, pEnd));
